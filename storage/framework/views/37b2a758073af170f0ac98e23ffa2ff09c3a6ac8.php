                ...
                <tbody>
                    <?php $__currentLoopData = $permessos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permesso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($permesso->docente()->first()->nome); ?></td>
                            <td><?php echo e($permesso->motivo()->first()->descrizione); ?></td>
                            <?php if($permesso->recupero === 1): ?>
                                <td>Recupero Necessario</td>
                            <?php else: ?>
                                <td>Recupero Non Necessario</td>
                            <?php endif; ?>

                            
                            <td class="text-center">
                                <a href="<?php echo e(route('info_permessi', $permesso->id)); ?>">
